...
import 'package:pengaduan_app/screen/pengaduan/penyuluhan_hukum/penyuluhan_detail_page.dart';
import 'package:pengaduan_app/screen/pengaduan/penyuluhan_hukum/penyuluhan_edit_page.dart';
import 'package:pengaduan_app/screen/pengaduan/penyuluhan_hukum/penyuluhan_hukum_page.dart';

import 'package:shared_preferences/shared_preferences.dart';

class PenyuluhanHukumListPage extends StatefulWidget {
  const PenyuluhanHukumListPage({Key? key}) : super(key: key);

  @override
  State<PenyuluhanHukumListPage> createState() =>
      _PenyuluhanHukumListPageState();
}

class _PenyuluhanHukumListPageState extends State<PenyuluhanHukumListPage> {
  ...
  Future<void> getJMS() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: {"kategori": "penyuluhan", "id_user": id},
      );
