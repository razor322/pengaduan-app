...
class PengaduanKorupsiDetailPage extends StatelessWidget {
  final Datum data;
  const PengaduanKorupsiDetailPage(this.data, {super.key});
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => PengaduanKorupsiListPage()));
          },
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(width: 10),
                              Text(
                                "Detail Laporan Pengaduan Korupsi",
                                style: TextStyle(
                          ...
                          children: <Widget>[
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('Uraian Laporan: ${data.uraianLaporan}'),
                                FilledButton.icon(
                                  onPressed: () {
