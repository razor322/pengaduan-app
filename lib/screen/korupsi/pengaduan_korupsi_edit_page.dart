...
import '../../model/korupsi/model_list_korupsi.dart';

class PengaduanKorupsiEditPage extends StatefulWidget {
  final Datum? data;
  const PengaduanKorupsiEditPage(this.data, {super.key});

  @override
  State<PengaduanKorupsiEditPage> createState() =>
      _PengaduanKorupsiEditPageState();
}

class _PengaduanKorupsiEditPageState extends State<PengaduanKorupsiEditPage> {
  File? _pdfFileKTP;
  ...
  TextEditingController _uraianlaporanController = TextEditingController();
  ...
  void initState() {
    ...
    _uraianlaporanController =
        TextEditingController(text: widget.data?.uraianLaporan);
  ...
  Future<void> registerAccount() async {
    try {
      ...
      if (_pdfFileKTP != null && _pdfFileLaporan != null) {
        var request =
            http.MultipartRequest('POST', Uri.parse('${url}updatekorupsi.php'));
        ...
        if (data.isSuccess) {
          ...
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) => PengaduanKorupsiListPage()),
            (route) => false,
          );
        } else {
          ScaffoldMessenger.of(context)
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Uraian Singkat Laporan',
                                labelStyle:
