...
class PenyuluhanEditPage extends StatefulWidget {
  final Datum? data;
  const PenyuluhanEditPage(this.data, {super.key});

  @override
  State<PenyuluhanEditPage> createState() => _PenyuluhanEditPageState();
}

class _PenyuluhanEditPageState extends State<PenyuluhanEditPage> {
  File? _pdfFileKTP;
  ...
  Future<void> registerAccount() async {
    try {
      ...
      if (_pdfFileKTP != null && _pdfFileLaporan != null) {
        ...
        request.fields['kategori'] = "penyuluhan";
        ...
        if (data.isSuccess) {
          ...
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) => PenyuluhanHukumListPage()),
            (route) => false,
          );
        } else {
          ScaffoldMessenger.of(context)
