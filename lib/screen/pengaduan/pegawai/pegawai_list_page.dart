...
import 'package:pengaduan_app/screen/pengaduan/pegawai/pegawai_detail_page.dart';
import 'package:pengaduan_app/screen/pengaduan/pegawai/pegawai_edit_page.dart';
import 'package:pengaduan_app/screen/pengaduan/pegawai/pengaduan_pegawai_page.dart';

import 'package:shared_preferences/shared_preferences.dart';

class PegawaiListPage extends StatefulWidget {
  const PegawaiListPage({Key? key}) : super(key: key);
  ...
  Future<void> getJMS() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: {"kategori": "pegawai", "id_user": id},
      );
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (context) => PengaduanPegawaipage()),
              (route) => false);
        },
        child: Icon(
          Icons.add,
