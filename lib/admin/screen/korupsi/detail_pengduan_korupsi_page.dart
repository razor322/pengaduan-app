...
class DetaiKorupsiPage extends StatelessWidget {
  final Datum data;
  const DetaiKorupsiPage(this.data, {super.key});
                          ...
                          children: <Widget>[
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                    'Uraian Singkat Laporan: ${data.uraianLaporan}'),
                                FilledButton.icon(
                                  onPressed: () {
