...
class PengaduanKorupsipage extends StatefulWidget {
  const PengaduanKorupsipage({super.key});

  @override
  State<PengaduanKorupsipage> createState() => _PengaduanKorupsipageState();
}

class _PengaduanKorupsipageState extends State<PengaduanKorupsipage> {
  File? _pdfFile;
  final _formKey = GlobalKey<FormState>();
  final _namaController = TextEditingController();
  final _nohpController = TextEditingController();
  final _noktpController = TextEditingController();
  final _uraianlaporanController = TextEditingController();
  ...
  Future<void> registerAccount() async {
    try {
      ...
      if (_pdfFileKTP != null && _pdfFileLaporan != null) {
        var request =
            http.MultipartRequest('POST', Uri.parse('$url/addkorupsi.php'));
  ...
  void dispose() {
    ...
    _uraianlaporanController.dispose();
    super.dispose();
  }
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Masukkan Uraian Laporan Anda!';
                                }
                                return null;
                              },
                            ),
