...
import 'package:pengaduan_app/screen/pengaduan/pilkada/pilkada_detail_page.dart';
import 'package:pengaduan_app/screen/pengaduan/pilkada/pilkada_edit_page.dart';
import 'package:pengaduan_app/screen/pengaduan/pilkada/posko_pilkada_page.dart';

import 'package:shared_preferences/shared_preferences.dart';

class PilkadaListPage extends StatefulWidget {
  const PilkadaListPage({Key? key}) : super(key: key);

  @override
  State<PilkadaListPage> createState() => _PilkadaListPageState();
}

class _PilkadaListPageState extends State<PilkadaListPage> {
  ...
  Future<void> getJMS() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: {"kategori": "pilkada", "id_user": id},
      );
