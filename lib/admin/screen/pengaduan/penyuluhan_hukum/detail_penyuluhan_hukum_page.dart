...
class DeatailPenyuluhanPage extends StatelessWidget {
  final Datum data;
  const DeatailPenyuluhanPage(this.data, {super.key});
      ...
      if (res.statusCode == 200) {
        ...
        if (data.isSuccess == true) {
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(
                  builder: (context) => PenyuluhanHukumListPage()),
              (route) => false);
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(width: 10),
                              Text(
                                "Detail Laporan Penyuluhan Hukum",
                                style: TextStyle(
